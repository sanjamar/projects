...
public class Representant extends Employee {
	...
	/*public Representant(String name, String surname, int age, String date) {
	...
	public Representant(String name, String surname, int age, String date, float turnover) {
		super(name, surname, age, date);
	...
	public String toString() {
		return "Representant [turnover=" + turnover + ", toString()=" + super.toString() + "]";
	}
